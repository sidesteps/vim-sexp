...
let s:sexp_mappings = {
    ...
    \ 'sexp_round_tail_wrap_element':      '<LocalLeader>I',
    ...
    \ 'sexp_round_head_wrap_list':   '<LocalLeader>W',
    \ 'sexp_round_tail_wrap_list':   '<LocalLeader>w',
    \ 'sexp_square_head_wrap_list':  '<LocalLeader>e[',
    \ 'sexp_square_tail_wrap_list':  '<LocalLeader>e]',
    \ 'sexp_curly_head_wrap_list':   '<LocklLeader>e{',
